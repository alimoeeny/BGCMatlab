...
% values, dVdt, pcs should match length(ispk).ispk should be abolsute
% indices from DATA.Spikes as some values (e.g. DATA.Spikes.enargy(ispk) can be recalculated
