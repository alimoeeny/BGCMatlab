function [ mycc ] = calibrateICCStereo(oldICCFilePath, outputPath, intendedLuminances, measuredLuminancesRightBlue, measuredLuminancesLeftRed, newName, varargin)
% oldICCFilePath the path to the icc profile used to do the measurements
% outputpath is the Name of the new new icc file.
...
[a,gof] = polyfit(intendedLuminances', measuredLuminancesRightBlue', 5);
foRight.p1 = a(1);
foRight.p2 = a(2);
foRight.p3 = a(3);
foRight.p4 = a(4);
foRight.p5 = a(5);
foRight.p6 = a(6);
[a, gof] = polyfit(intendedLuminances', measuredLuminancesLeftRed', 5);
foLeft.p1 = a(1);
foLeft.p2 = a(2);
foLeft.p3 = a(3);
foLeft.p4 = a(4);
...
GetFigure('Luminance Measurements');, clf, hold on, 
...
yRight(yRight > 256) = 256;
yLeft(yLeft > 256) = 256;
GetFigure('New ICC Table');, clf, hold on
