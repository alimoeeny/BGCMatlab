...
copyscript('/bgc/spike2/scripts/bgcs devel.s2s','C:/Spike2/bgcs.s2s');
copyscript('/bgc/spike2/scripts/slave.s2s','C:/Spike2/slave.s2s');
copyscript('/bgc/spike2/scripts/SetConfig.s2s','C:/Spike2/SetConfig.s2s');
copyscript('/bgc/spike2/scripts/MakeSpikeWaves.s2s','C:/Spike2/MakeSpikeWaves.s2s');
copyscript('/bgc/spike2/scripts/MakeMaton.s2s','C:/Spike2/MakeMaton.s2s');
